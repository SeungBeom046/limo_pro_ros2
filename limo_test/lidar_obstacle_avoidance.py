...
class LidarObstacleAvoidance:
    ...
    def _declare_parameters(self):
        ...
        self.node.declare_parameter("aeb_distance", 0.25)
        self.node.declare_parameter("wide_aeb_distance", 0.23)
        self.node.declare_parameter("wide_aeb_side_distance", 0.16)
